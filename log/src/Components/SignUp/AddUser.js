  ...
  return (
    <div className="container">
      ...
      <div className="d-flex justify-content-center align-items-center">
        <form method="POST" action="/addUser" encType="application/json">
          ...
          <div className="form-group p-2">
            ...
            />
            {emailAlreadyExsist && <span>Email already exsist</span>}
          </div>
          <div className="form-group p-2">
          ...
          {createSuccess && (
            <div className="alert alert-primary">User Created Succesfully</div>
          )}
        </form>
      </div>
    </div>
