              ...
              <div key={item.id}>
                <div className="bg-[#F8FAFC] rounded-3xl mt-4 flex h-24 pe-4 drop-shadow-xl">
                  ...
                  <div className="w-full pt-2 ps-2">
                    ...
                    <p className="font-thin text-xs ">Calories 40 - 4 person</p>
      ...
      {cartItems.length > 0 && (
        <div className="absolute bottom-10 w-full pe-4">
          ...
          <div className="flex justify-between p-4">
            ...
            <span className="font-bold text-lg">
              ({cartItems.length} item ) ₹{(totalAmount + 36.33).toFixed(2)}
            </span>
          </div>

          <div className="flex items-center justify-center mt-2">
          <Link to="/meals">
              <button className="bg-[#111827] text-[#D1D7DC] ps-3 pe-3 pt-2 pb-2 rounded-3xl m-1">
                Continue shopping
              </button>
            </Link>
            <Link to="/checkout">
